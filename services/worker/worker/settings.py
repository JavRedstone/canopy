...
class WorkerSettings(BaseSettings):
    ...
    def require_runtime_configuration(self) -> None:
        ...
        if self.openai_provider == "azure":
            ...
            if not self.azure_openai_planner_deployment or not self.azure_openai_embedding_deployment:
                raise RuntimeError(
                    "APP_AZURE_OPENAI_PLANNER_DEPLOYMENT and APP_AZURE_OPENAI_EMBEDDING_DEPLOYMENT must be "
                    "configured when APP_OPENAI_PROVIDER=azure."
                )
