...
| Multi-language sandbox (Python, Python/ML, C++, C, JS, Go today) | ✅ | n/a | ⚠️ depends on the chat client | ✅ | n/a |
| Citations grounded to your actual source excerpts, clickable to the real text | ✅ | ✅ | ⚠️ often unverifiable | n/a | ⚠️ shows search results, not curated citations |
